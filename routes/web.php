...
// Página principal con contenido de inicio
...
// Ruta para comentarios anónimos
Route::post('/comentarios/{partidoId}', [ComentarioController::class, 'store'])->name('comentarios.store');

// Rutas de clasificación
Route::get('/equipos', [EquipoController::class, 'index'])->name('equipos.index');

// Rutas de administración con middleware de autenticación
...
// Rutas de autenticación para el administrador
Route::get('/admin/login', [AdministradorController::class, 'showLoginForm'])->name('admin.login');
Route::post('/admin/login', [AdministradorController::class, 'login'])->name('admin.login.submit');
